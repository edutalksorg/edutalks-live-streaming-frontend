...
import {
    ...
    FaShieldAlt, FaComments, FaUsers, FaSmile
} from 'react-icons/fa';
                ...
                <div className="fixed inset-0 z-[200000] bg-surface flex flex-col items-center justify-center text-center p-8 backdrop-blur-xl">
                    ...
                    <div className="relative space-y-8 max-w-md w-full animate-in zoom-in duration-500">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-accent-gray text-lg leading-relaxed">The instructor has ended the live session. You will be redirected to the dashboard shortly.</p>
                        </div>
                        <div className="pt-4">
